...
export const DEFAULT_BRANDING = {
  name: '',
  tagline: 'Your church, in one app',
  contactEmail: '',
  frontDoor: {
 ...
 */
export const withBrandingDefaults = (stored, fallbackName = 'Church App') => {
...
// The colours the app was built in. `primary` is the accent on a light page,
// `primaryDark` the accent on a dark one — a lighter shade, because the light
// page's teal disappears against gray-900.
