...
export const versionHistory = [
  ...
  },
  {
    ...
    summary:
      'The app can now serve many churches, each at its own address with its own people and records, and only the people your church lets in can open yours.',
    highlights: [
      'Someone new signs in and asks to join. Administrators let them in from the top of Accounts, and their app opens straight away.',
      'Administrators can remove somebody from the church from their account in Accounts.',
      'The Claude connector now has a link of its own for your church, made under Settings → Claude connector.',
    ],
  },
  {
    version: '0.21.0',
