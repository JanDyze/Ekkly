...
// The colours and the face every church starts with, and the front door wears.
// A church's administrators can choose their own in their Settings; a church
// that has not follows these, and follows them again the moment it resets.
...
onMounted(async () => {
  try {
    ...
    toast.error(error.message || 'Could not load the look.')
  }
})
...
<template>
  ...
  <SectionCard
    ...
    subtitle="The look every church starts with. Churches can choose their own."
  >
